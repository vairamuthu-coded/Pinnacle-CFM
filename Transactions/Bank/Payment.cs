...
namespace Pinnacle.Transactions.Bank
{
    public partial class Payment : Form,ToolStripAccess
    {
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            //    DataGridViewRow dv = dataGridView1.Rows[e.RowIndex];
            //    GridID = Convert.ToInt32(dv.Cells["asptbladvpaymasid"].Value.ToString());
            //    //string update = "update asptbladvpaymas set approval='T',conformed='T'  where asptbladvpaymasid='" + dv.Cells["asptbladvpaymasid"].Value.ToString() + "'";
            //    //Utility.ExecuteNonQuery(update);
            //    //pop1(0, dataGridView1);
            //}
        }
